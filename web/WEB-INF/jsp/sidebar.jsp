...
<%@taglib prefix="n" uri="http://java.sun.com/jstl/fmt" %>
<!-- Sidebar ================================================== -->
<div id="sidebar" class="span3">
    ...
    <c:forEach var="i" begin="0" end="2" step="1" items="${listproduct}">
        <div class="thumbnail">
            ...
            <div class="caption">
                <h5>${i.productName}</h5>
                <h4 style="text-align:center"><a class="btn" href="#"> <i class="icon-zoom-in"></i></a> <a class="btn" href="${pageContext.request.contextPath}/shopcart/orderproduct/${i.id}">Add to <i class="icon-shopping-cart"></i></a> <a class="btn btn-primary" href="#">Rp. ${i.productPrice}</a></h4>
            </div>
        </div><br/>
    </c:forEach>
